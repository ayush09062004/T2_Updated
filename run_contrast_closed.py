...
# or only load pickled data
    ...
    setup_logging()
    data_store = PickledDataStore(load=True,parameters=ParameterSet({'root_directory':'ThalamoCorticalModel_ContrastClosed_Run1_____', 'store_stimuli' : False}),replace=True)
